...
def prepare(rType="MAIN"):
    ...
    try:
        ...
        # Create User
        printc("Creating user thunderciper")
        os.system("adduser --system --shell /bin/false --group --disabled-login thunderciper > /dev/null")
    if not os.path.exists("/home/thunderciper"): os.mkdir("/home/thunderciper")
    return True
...
def install(rType="MAIN"):
    ...
    try: rURL = rDownloadURL % rInstall[rType]
        ...
        return False
    os.system('wget -q -O "/tmp/thunderciper.tar.gz" "%s"' % rURL)
    if os.path.exists("/tmp/thunderciper.tar.gz"):
        printc("Installing Software")
        os.system('tar -zxvf "/tmp/thunderciper.tar.gz" -C "/home/thunderciper/" > /dev/null')
    ...
    for i in range(5):
        ...
        try:
            if rDrop:
                ...
                os.system("mysql -u root%s xtream_iptvpro < /home/thunderciper/iptv_xtream_codes/database.sql > /dev/null" % rExtra)
                ...
                os.system('mysql -u root%s -e "USE xtream_iptvpro; REPLACE INTO reg_users (id, username, password, email, member_group_id, verified, status) VALUES (1, \'admin\', \'\$6\$rounds=20000\$thunderciper\$XThC5OwfuS0YwS4ahiifzF14vkGbGsFF1w7ETL4sRRC5sOrAWCjWvQJDromZUQoQuwbAXAFdX3h3Cp3vqulpS0\', \'admin@website.com\', 1, 1, 1);" > /dev/null'  % rExtra)
            ...
            try: os.remove("/home/thunderciper/iptv_xtream_codes/database.sql")
            except: pass
            return True
...
def encrypt(rHost="127.0.0.1", rUsername="user_iptvpro", rPassword="", rDatabase="xtream_iptvpro", rServerID=1, rPort=7999):
    printc("Encrypting...")
    try: os.remove("/home/thunderciper/iptv_panel/config")
    except: pass
    rf = open('/home/thunderciper/iptv_panel/config', 'wb')
...
def configure():
    ...
    if not "/home/thunderciper/iptv_panel/" in open("/etc/fstab").read():
        rFile = open("/etc/fstab", "a")
        rFile.write("tmpfs /home/thunderciper/iptv_panel/streams tmpfs defaults,noatime,nosuid,nodev,noexec,mode=1777,size=90% 0 0\ntmpfs /home/thunderciper/iptv_panel/tmp tmpfs defaults,noatime,nosuid,nodev,noexec,mode=1777,size=2G 0 0")
        rFile.close()
